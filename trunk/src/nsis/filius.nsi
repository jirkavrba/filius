...
Section "Filius" SEC01
  ...
  File "classes\config\Desktop.txt"
  File "classes\config\Desktop_en_GB.txt"
  File "classes\config\filetypes.txt"
  File "classes\config\filius.ini"
  SetOutPath "$INSTDIR"
  ...
  File "classes\hilfe\design_mode.html"
  File "classes\hilfe\entwurfsansichtDetail.html"
  File "classes\hilfe\entwurfsmodus.html"
  SetOutPath "$INSTDIR\hilfe\gfx"
  File "classes\hilfe\gfx\aktionsmodus.png"
  File "classes\hilfe\gfx\button_wizard.png"
  File "classes\hilfe\gfx\draganddrop.gif"
  File "classes\hilfe\gfx\draganddrop.png"
  File "classes\hilfe\gfx\eigenschaften.png"
  File "classes\hilfe\gfx\entwurfsansicht.png"
  File "classes\hilfe\gfx\entwurfsmodus.png"
  File "classes\hilfe\gfx\icon_softwareinstallation.png"
  File "classes\hilfe\gfx\netzwek_aus.png"
  File "classes\hilfe\gfx\tutorial1.png"
  File "classes\hilfe\gfx\tutorial2.png"
  File "classes\hilfe\gfx\verkabeln.png"
  SetOutPath "$INSTDIR\hilfe"
  File "classes\hilfe\simulationsmodus.html"
  File "classes\hilfe\simulation_mode.html"
  SetOutPath "$INSTDIR\img"
  File "classes\img\email_icon.png"
  ...
  File "classes\tmpl\firewall_konfig_webseite_de_DE.txt"
  File "classes\tmpl\firewall_konfig_webseite_en_GB.txt"
  File "classes\tmpl\http_fehler.txt"
  SetOutPath "$INSTDIR\tmpl\quelltext_vorlagen"
  File "classes\tmpl\quelltext_vorlagen\client.txt"
  File "classes\tmpl\quelltext_vorlagen\client_gui.txt"
  File "classes\tmpl\quelltext_vorlagen\server.txt"
  File "classes\tmpl\quelltext_vorlagen\server_gui.txt"
  File "classes\tmpl\quelltext_vorlagen\server_mitarbeiter.txt"
  SetOutPath "$INSTDIR\tmpl"
  File "classes\tmpl\routing_de_DE.html"
  File "classes\tmpl\routing_en_GB.html"
  File "classes\tmpl\vermittlung_index_de_DE.txt"
  File "classes\tmpl\vermittlung_index_en_GB.txt"
  File "classes\tmpl\webserver_index.txt"
